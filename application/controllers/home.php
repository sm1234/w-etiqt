...
class Home_Controller extends Base_Controller {
	...
	*/
	...
	{
		$allProducts = Product::with(array('images'=>function($query){$query->where_status('1')->where_is_key('1');}))->where_status('1')->order_by('row_num','asc')->order_by('col_num','asc')->paginate(12);
